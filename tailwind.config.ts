...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'slide-from-down-and-fade-1': 'slideFromDownAndFade 0.6s ease-in-out 0.1s both',
        'slide-from-down-and-fade-2': 'slideFromDownAndFade 0.6s ease-in-out 0.2s both',
        'slide-from-down-and-fade-3': 'slideFromDownAndFade 0.6s ease-in-out 0.3s both',
        'slide-from-down-and-fade-4': 'slideFromDownAndFade 0.6s ease-in-out 0.4s both',
        'slide-from-down-and-fade-5': 'slideFromDownAndFade 0.6s ease-in-out 0.5s both',
        'slide-from-down-and-fade-6': 'slideFromDownAndFade 0.6s ease-in-out 0.6s both',
      },
    },
  },
  safelist: [
